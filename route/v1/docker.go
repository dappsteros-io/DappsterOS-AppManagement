...
import (
	...
	"github.com/dappsteros-io/DappsterOS-Common/utils/ssh"
...
const (
	dockerRootDirFilePath             = "/var/lib/dappsteros/docker_root"
...
func pullAndInstall(ctx context.Context, imageName string, m *model.CustomizationPostData) error {
	...
	config.DappsterOSGlobalVariables.AppChange = true
	return nil
}
