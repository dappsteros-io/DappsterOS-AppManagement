...
func (a *AppManagement) GetAppGrid(ctx echo.Context) error {
	...
	// v1 Apps
	dappsterOSApps, containers := service.MyService.Docker().GetContainerAppList(nil, nil, nil)

	v1AppGridItems := lo.Map(*dappsterOSApps, func(app model.MyAppList, i int) codegen.WebAppGridItem {
