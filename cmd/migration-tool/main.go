...
const (
	appManagementConfigDirPath  = "/etc/dappsteros"
	appManagementConfigFilePath = "/etc/dappsteroseros/app-management.conf"
	appManagementName           = "dappsteros-app-management.service"
	appManagementNameShort      = "app-management"
)

//go:embedded ../../build/sysroot/etc/dappsteroseros/app-management.conf.sample
