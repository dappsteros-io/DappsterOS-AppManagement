...
func TestSkipUpdateCatalog(t *testing.T) {
	...
	appStoreURL := []string{
		"https://dappsteros.app/store/main.zip",
		"https://dappsteros.oss-cn-shanghai.aliyuncs.com/store/main.zip",
	}
...
func TestStoreRoot(t *testing.T) {
	...
	expectedStoreRoot := filepath.Join(workdir, "github.com", "DappsterOS", "DappsterOS-rOS-AppStore", "main")
