...
readonly CASA_SERVICES=(
    "dappsteros-app-management.service"
)

readonly CASA_EXEC=dappsteros-app-management
readonly CASA_CONF=/etc/dappsteros/app-management.conf
readonly CASA_DB=/var/lib/dappsteros/db/app-management.db
